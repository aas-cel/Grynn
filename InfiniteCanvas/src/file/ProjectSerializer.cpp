...
bool ProjectSerializer::serialize(const std::string& path, const std::vector<std::shared_ptr<Note>>& notes) {
...
bool ProjectSerializer::deserialize(const std::string& path, std::vector<std::shared_ptr<Note>>& notes) {
